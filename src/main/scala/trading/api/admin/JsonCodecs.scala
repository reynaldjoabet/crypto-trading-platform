...
object JsonCodecs {
  ...
  // ── money codecs ──
  given Encoder[Symbol] = Encoder.encodeString.contramap(s => s: String)
  given Decoder[Symbol] = Decoder.decodeString.emap(Symbol.apply)
  given Encoder[CurrencyCode] = Encoder.encodeString.contramap(c => c: String)
  given Decoder[CurrencyCode] = Decoder.decodeString.emap(CurrencyCode.apply)
  given Encoder[Price] = Encoder.encodeBigDecimal.contramap(_.value)
  given Decoder[Price] = Decoder.decodeBigDecimal.emap(Price.apply)
  given Encoder[Quantity] = Encoder.encodeBigDecimal.contramap(_.value)
  given Decoder[Quantity] = Decoder.decodeBigDecimal.emap(Quantity.apply)
  given Encoder[Amount] = Encoder.encodeBigDecimal.contramap(_.value)
  given Decoder[Amount] = Decoder.decodeBigDecimal.emap(Amount.apply)
  given Encoder[Percent] = Encoder.encodeDouble.contramap(_.value)
  given Decoder[Percent] = Decoder.decodeDouble.emap(Percent.apply)
  given Encoder[FeeBps] = Encoder.encodeInt.contramap(_.value)
  given Decoder[FeeBps] = Decoder.decodeInt.emap(FeeBps.apply)
